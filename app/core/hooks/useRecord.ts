...
const useRecord = () => {
    ...
    const playSoundStartRecording = usePlaySound(require('@sounds/startRecording.wav'));
    const playSoundStopRecording = usePlaySound(require('@sounds/stopRecording.wav'));
    const playSoundSuccessRecording = usePlaySound(require('@sounds/success.wav'));
