		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					correct: false,
					feedback:
						"Incorrect. 'Perro' translates to 'dog' in English."
				},
				{
					id: 3,
					content: 'conejo',
					correct: false,
					feedback:
						"Incorrect. 'Conejo' translates to 'rabbit' in English."
				}
			]
		},
		{
			id: 3,
			content: 'Apple',
			type: PreTaskTypeQuestion.AUDIO_MULTIPLE_CHOICE,
			imgAlt: 'Manzana',
			...
			options: [
				{
					...
					correct: true,
					feedback:
						"Correct! 'Manzana' translates to 'apple' in english."
				},
				{
					id: 2,
					content: 'Orange',
					correct: false,
					feedback:
						"Incorrect. 'Orange' translates to 'naranja' in Spanish."
				},
				{
					id: 3,
					content: 'Pineapple',
					correct: false,
					feedback:
						"Incorrect. 'Pineapple' translates to 'piña' in Spanish."
				}
			]
		},
		{
		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					correct: false,
					feedback:
						"Incorrect. 'Gato' translates to 'cat' in English."
				},
				{
					id: 3,
					content: 'pájaro',
					correct: false,
					feedback:
						"Incorrect. 'Pájaro' translates to 'bird' in English."
				}
			]
		},
		{
